--src contains servlets and java classes for business logic 

-- index.jsp, results.jsp are home page and the result page of the application. 

--small set of data contains 9 docs for testing purpose

-- Entire set can be found on google drive

-- single and multiple keyword query is implemenetd using vector space model

-- wildcard query(*) implemented for single term  (Vismay)

-- spelling checker implemented. (Gourang)
